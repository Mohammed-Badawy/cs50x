...
void tabulate(void)
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        ...
        for (int j = 0; j < candidate_count; j++)
        {
            ...
            // If non-eliminated candidate add vote
...
bool is_tie(int min)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        // Count  candidates still in race
        if (!candidates[i].eliminated)
        {
            candidates_in_race++;
            
            // Count candidates with min votes
    ...
    // Tie
    if (candidates_in_race == candidate_min_votes)
    {
        return true;
    }
